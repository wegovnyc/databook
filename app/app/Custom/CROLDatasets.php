...
class CROLDatasets
{
	public $dd = [
		'public-hearings' => [
			...
			'flds' => [
					...
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/public-hearings">${r["wegov-org-name"]}</a>` }',
		...
		'contract-awards' => [
			...
			'flds' => [
					'function (r) { return `<a href="https://a856-cityrecord.nyc.gov/RequestDetail/${r["RequestID"]}" target="_blank">${r["RequestID"]}</a>` }',
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/contract-awards">${r["wegov-org-name"]}</a>` }',
					'"TypeOfNoticeDescription"', '"ShortTitle"',
					'function (r) { return usToDashDate(r["EventDate"]) }',
				    'function (r) { 
						var rr = [r["EventStreetAddress1"], r["EventStreetAddress2"], r["EventCity"], r["EventStateCode"], r["EventZipCode"]];
		...
		'special-materials' => [
			...
			'flds' => [
					...
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/special-materials">${r["wegov-org-name"]}</a>` }',
					'"TypeOfNoticeDescription"', '"ShortTitle"',
					'function (r) { 
						var rr = [r["EventStreetAddress1"], r["EventStreetAddress2"], r["EventCity"], r["EventStateCode"], r["EventZipCode"]];
						while (true) {
		...
		'agency-rules' => [
			...
			'flds' => [
					'function (r) { return `<a href="https://a856-cityrecord.nyc.gov/RequestDetail/${r["RequestID"]}" target="_blank">${r["RequestID"]}</a>` }',
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/agency-rules">${r["wegov-org-name"]}</a>` }',
					'"TypeOfNoticeDescription"', '"ShortTitle"', 
					'function (r) { return usToDashDate(r["EventDate"]) }',
					'function (r) { 
						var rr = [r["EventStreetAddress1"], r["EventStreetAddress2"], r["EventCity"], r["EventStateCode"], r["EventZipCode"]];
		...
		'property-disposition' => [
			...
			'flds' => [
					'function (r) { return `<a href="https://a856-cityrecord.nyc.gov/RequestDetail/${r["RequestID"]}" target="_blank">${r["RequestID"]}</a>` }',
					'function (r) { return usToDashDate(r["StartDate"]) }',
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/property-disposition">${r["wegov-org-name"]}</a>` }',
					'"TypeOfNoticeDescription"', '"ShortTitle"', 
					'function (r) { return usToDashDate(r["EventDate"]) }',
					'function (r) { 
						var rr = [r["EventStreetAddress1"], r["EventStreetAddress2"], r["EventCity"], r["EventStateCode"], r["EventZipCode"]];
		...
		'court-notices' => [
			...
			'flds' => [
					'function (r) { return `<a href="https://a856-cityrecord.nyc.gov/RequestDetail/${r["RequestID"]}" target="_blank">${r["RequestID"]}</a>` }',
					'function (r) { return usToDashDate(r["StartDate"]) }',
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/court-notices">${r["wegov-org-name"]}</a>` }',
					'"ShortTitle"', 
					'function (r) { return usToDashDate(r["EventDate"]) }',
					'function (r) { 
						var rr = [r["EventStreetAddress1"], r["EventStreetAddress2"], r["EventCity"], r["EventStateCode"], r["EventZipCode"]];
		...
		'procurement' => [
			...
			'flds' => [
					'function (r) { return `<a href="https://a856-cityrecord.nyc.gov/RequestDetail/${r["RequestID"]}" target="_blank">${r["RequestID"]}</a>` }',
					'function (r) { return usToDashDate(r["StartDate"]) }',
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/procurement">${r["wegov-org-name"]}</a>` }',
					'"TypeOfNoticeDescription"', '"CategoryDescription"',
					'function (r) { var t = r["ShortTitle"] || ""; if (r["resolved_ctr_id"]) return `${t} <a href="/procurement/contract/${r["resolved_ctr_id"]}" class="db-badge db-badge-navy" style="text-decoration:none;margin-left:4px;">View contract</a>`; if (r["resolved_epin"]) return `${t} <a href="/procurement/solicitation/${r["resolved_epin"]}" class="db-badge db-badge-navy" style="text-decoration:none;margin-left:4px;">View solicitation</a>`; return t; }',
		...
		'change-of-personnel' => [
			...
			'flds' => [
					...
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/change-of-personnel">${r["wegov-org-name"]}</a>` }',
					...
					'function (r) { 
						...
						return `<a href="/t/${code}-profile">${code}</a>`;
					}', 
		...
		'all' => [
			...
			'flds' => ['function (r) { return usToDashDate(r["StartDate"]); }', 
					'function (r) { return `<a href="https://a856-cityrecord.nyc.gov/RequestDetail/${r["RequestID"]}" target="_blank">${r["RequestID"]}</a>` }',
					'"TypeOfNoticeDescription"', '"CategoryDescription"', 
					'function (r) { return `<a href="/o/${r["wegov-org-id"]}-${slug(r["wegov-org-name"])}/notices">${r["wegov-org-name"]}</a>` }',
	...
	public $list = [
		...
		'change-of-personnel' => 'Change in Personnel',
	];
