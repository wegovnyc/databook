...
<div class="inner_container">
	...
	<div class="container">
		<div class="row my-4">
			<div class="col-md-12">
				...
				<p class="lead">Our city’s infrastructure – its roads, sewers, parks, public hospitals and more – is funded and managed through a complex capital program. We use NYC Open Data to explain & explore it.</p>
			</div>
		</div>	
		...
		<div class="row mb-4">
			...
			<div class="col-12">
				...
				<p class="lead">Our project profiles combine Strategy, Budget and Commitment datasets with OMB’s <a href="https://www.nyc.gov/site/omb/publications/fy23-sccp.page" target="_blank">Capital Project Details Data reports</a> and <a href="https://capitalplanning.nyc.gov/map/capitalprojects#10/40.7128/-74.0807" target="_blank">City Planning’s location data</a>.</p>
				...
				<div class="float-left mr-4 my-4">
					<a href="{!! route('projects') !!}" class="float-left no-underline">
						<span class="type-label">View Major Projects</span>
					</a>
				</div>
				<div class="float-left mr-4 my-4">
					<a href="{!! route('mProjects') !!}" class="float-left no-underline">
						<span class="type-label">View Minor Projects</span>
					</a>
				</div>
			</div>
		</div>	
	...
	<div class="container">
		...
		{{--<div class="row mb-4">
			<div class="col-12">
				<div class="accordion social_media">
					<button class="social_btn" style="background-image: unset; cursor: default;">
						<i class="bi-geo-alt" style="font-weight: 600; font-size: 1.5rem;"></i>&nbsp;&nbsp;Our map uses data from <a href="https://data.cityofnewyork.us/City-Government/Capital-Projects-Database-CPDB-Projects-Polygons-/9jkp-n57r/" target="_blank">Capital Projects Database (CPDB) - Projects (Polygons)</a>, <a href="https://data.cityofnewyork.us/City-Government/Capital-Projects-Database-CPDB-Projects-Points-/h2ic-zdws/" target="_blank">Capital Projects Database (CPDB) - Projects (Points)</a> datasets.
					</button>
				</div>
			</div>
		</div>
		...
		for (let sel in uu) {
			fapireq(uu[sel], function (resp) {
				...
				if ((['#orig_cost', '#curr_cost', '#over_budg_am'].includes(sel)) && (v != '-')) {
					$(sel).text(toFinShortK(v, 1000000))
					$(sel).attr('data-content', toFin(v, 1000000))
				}						
				else 
