    ...
    <div class="inner_container">
        <div class="container db-hero-inner">
            <div class="db-hero-copy">
                ...
                <h1>Revenue @include('procurement.partials.source_badge', ['source' => 'checkbook'])</h1>
                <p style="max-width: 62ch; font-size: var(--db-text-lg); line-height: 1.5; color: var(--db-text-on-navy-muted); margin: var(--db-space-2) 0 0;">Revenue the City of New York expects and recognizes — adopted vs modified vs recognized, by agency and revenue category. Sourced from <a href="https://www.checkbooknyc.com" target="_blank" rel="noopener" style="color: var(--db-on-dark-accent);">Checkbook NYC</a>.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="inner_container">
    <div class="container" style="padding-top: var(--db-space-5); padding-bottom: var(--db-space-8);">
        ...
        <div class="db-empty" style="margin-top: var(--db-space-4);">
            ...
            <div class="db-empty-title">Revenue data not yet available</div>
            <div class="db-empty-text">The revenue dataset is being prepared. Check back soon.</div>
        </div>
        @else
        ...
        <div style="display: flex; align-items: baseline; gap: var(--db-space-2); margin-bottom: var(--db-space-3);">
            ...
            <span style="color: var(--db-text-muted); font-size: var(--db-text-sm);">revenue</span>
        </div>
        ...
        {{-- By-agency table with realization bars --}}
