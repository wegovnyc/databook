...
@section('head')
	<meta name="description" content="A consolidated list of items being sold by city agencies" />
	<meta rel="canonical" href="{!! route('auctions') !!}" />
@endsection
		...
		<div id="pos-header" class="org-header">
			<div class="row m-2">
				<div class="col-md-9 org_detailheader">
					...
					<h1 class="main_hdr db-profile-title">{{ $details['title'] }}</h1>
